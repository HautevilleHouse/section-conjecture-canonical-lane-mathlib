# Section Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/section-conjecture-canonical-lane-mathlib.git
cd section-conjecture-canonical-lane-mathlib
lake exe
lake build
```
