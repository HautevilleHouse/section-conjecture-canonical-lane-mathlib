/-!
# section-conjecture-canonical-lane Lean migration boundary
...
`SectionConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "section-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/section-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Section Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["anabelian-geometry", "arithmetic-geometry", "etale-fundamental-group", "galois-sections", "mathematical-proof", "reproducibility", "section-conjecture", "manifold-constrained", "canonical-lane", "local-to-global"]
